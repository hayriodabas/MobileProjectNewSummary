import 'package:flutterfire/model/model.dart';
...
List<LineSeries<_ChartData, num>> getDashedLineSeries(bool isTileView) {
  final List<_ChartData> chartData = <_ChartData>[
    _ChartData(5, 6.6, 9.0, 15.1, 18.8),
    _ChartData(6, 6.3, 9.3, 15.5, 18.5),
    _ChartData(7, 6.7, 10.2, 14.5, 17.6),
    _ChartData(8, 6.7, 10.2, 13.9, 16.1),
    _ChartData(9, 6.4, 10.9, 13, 17.2),
    _ChartData(10, 6.8, 9.3, 13.4, 18.9),
    _ChartData(11, 7.7, 10.1, 14.2, 19.4),
  ];
